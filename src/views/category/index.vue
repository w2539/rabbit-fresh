<template>
  <div class="top-category">
    <div class="container">
      ...
      <!-- 各个分类推荐商品 -->
      <div class="ref-goods" v-for="sub in List" :key="sub.id">
        <div class="head">
          <h3>- {{ sub.name }} -</h3>
...
import GoodsItem from './components/good-items.vue'
  ...
  setup () {
    ...
    const getSubList = () => {
      findTopCategory(route.params.id).then((data) => {
        List.value = data.result.children
      })
    }
    ...
    return { sliders, topCategory, List }
  }
}
</script>
