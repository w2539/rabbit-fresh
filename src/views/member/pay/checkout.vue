  ...
  <div class="xtx-pay-checkout-page">
    <div class="container">
      ...
      <div class="wrapper" v-if="checkoutInfo">
        ...
        <div class="box-body">
          <CheckoutAddress :list="checkoutInfo.userAddresses" @change="changeAddress"></CheckoutAddress>
        </div>
        <!-- 商品信息 -->
        ...
        <div class="box-body">
          <table class="goods">
            ...
            <tbody>
              <tr v-for="items in checkoutInfo.goods" :key="items.id">
                <td>
                ...
                <td>&yen;{{ items.price }}</td>
                <td>{{ items.count }}</td>
                <td>&yen;{{ items.totalPayPrice }}</td>
                <td>&yen;{{ items.totalPrice }}</td>
              </tr>
            </tbody>
          </table>
        </div>
